    ...
    <div className="animate-in fade-in duration-700">
      <DynamicGlowCard variant="purple" className="p-6 mb-6">
        ...
        <p className="text-gray-300 mb-6">
          ...
          individuals can become distributors by staking tokens. Distributors manage a{" "}
          <strong>digital inventory of tokens</strong> rather than physical coffee, creating a vendor-managed inventory
          system that reduces overhead and risk. These tokens represent claims on physical coffee that is stored in
          secure warehouses until redemption, allowing distributors to focus on sales and marketing without handling
          physical inventory.
        </p>
        ...
        <div className="bg-black/30 border border-purple-500/20 rounded-lg p-4 mb-6">
          <h3 className="text-lg font-medium text-purple-300 mb-3">Token-Based Inventory System</h3>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                <li className="flex items-start">
                  ...
                  <span>
                    Distributors stake tokens to join the network and receive discounted access to coffee tokens
                  </span>
                </li>
                <li className="flex items-start">
                  <div className="bg-purple-900/30 p-1 rounded-full mr-2 mt-0.5">
                  ...
                  <span>Distributors purchase coffee tokens that represent physical coffee stored in warehouses</span>
                </li>
                <li className="flex items-start">
                  <div className="bg-purple-900/30 p-1 rounded-full mr-2 mt-0.5">
                    <span className="text-xs text-purple-300">3</span>
                  </div>
                  <span>When customers order coffee, distributors redeem tokens to trigger fulfillment</span>
                </li>
                <li className="flex items-start">
                  <div className="bg-purple-900/30 p-1 rounded-full mr-2 mt-0.5">
                    <span className="text-xs text-purple-300">4</span>
                  </div>
                  <span>Smart contracts automatically coordinate with 3PL providers for physical delivery</span>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                <li className="flex items-start">
                  <Check className="h-4 w-4 text-emerald-400 mr-2 mt-0.5 flex-shrink-0" />
                  <span>No physical inventory to manage, store, or ship</span>
                </li>
                <li className="flex items-start">
                  <Check className="h-4 w-4 text-emerald-400 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Reduced overhead costs and capital requirements</span>
                </li>
                <li className="flex items-start">
                  <Check className="h-4 w-4 text-emerald-400 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Blockchain-verified authenticity and traceability</span>
                </li>
                <li className="flex items-start">
                  <Check className="h-4 w-4 text-emerald-400 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Automated fulfillment through integrated 3PL providers</span>
                </li>
                <li className="flex items-start">
                  <Check className="h-4 w-4 text-emerald-400 mr-2 mt-0.5 flex-shrink-0" />
                  <span>Scalable business model with minimal logistics complexity</span>
                </li>
              </ul>
            </div>
          </div>
