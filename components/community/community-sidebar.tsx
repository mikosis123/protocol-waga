...
export function CommunitySidebar() {
  ...
  const navItems = [
    { href: "/community/dashboard", label: "Dashboard", icon: <LayoutDashboard size={20} /> },
    { href: "/community/members", label: "Members", icon: <Users size={20} /> },
    { href: "/community/events", label: "Events", icon: <Calendar size={20} /> },
    { href: "/community/resources", label: "Resources", icon: <FileText size={20} /> },
    { href: "/community/forums", label: "Forums", icon: <MessageSquare size={20} /> },
    { href: "/community/register", label: "Register", icon: <UserPlus size={20} /> },
    { href: "/community/founding-member", label: "Founding Member", icon: <Users size={20} /> },
  ]
